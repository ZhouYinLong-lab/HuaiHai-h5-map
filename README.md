...
本项目的原创源代码、界面设计、原创地图、像素资源、文案组织、项目名称及整体视觉方案，版权归 ZhouYinLong 所有，保留全部权利。除法律明确允许或版权所有者另行书面授权外，不得复制、修改、改编、反向工程、再发布、商业使用或用于其他项目。本项目不授予 MIT 或其他开源许可，详见 [`LICENSE`](LICENSE)。

页面中的历史资料、图片、地图和外部平台内容，其权利归原作者或原权利人所有；第三方依赖、平台服务及明确标注外部来源的内容不在本声明授予范围内，相关内容仅用于社会实践成果展示与红色文化传播。
