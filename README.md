...
本项目原创部分采用专有版权声明（All Rights Reserved），不采用 MIT 或其他开源许可。未经版权所有者 ZhouYinLong 书面许可，不得复制、修改、分发、再许可或用于其他项目。第三方依赖、平台服务及明确标注外部来源的图片和资料，仍按各自权利人的许可或授权条款执行，详见 [`LICENSE`](LICENSE)。
